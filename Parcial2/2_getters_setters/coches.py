"""
Clases:es un molde a traves del cual se pede instanciar un objeto dentro de las clases se definen 
atributos (propiedades / caracteristicas) y los metodos (funciones o acciones)
--------------------------------------------------------------------------------------------------------
Objetos:Objetos o instancias: son parte de una clase, los objetos o instancias pertenecen a una clase
...
#para cambiar o modificar el valor del atributo o propiedad en cuestion
